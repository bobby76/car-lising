 ...
 *
	* Template Name: Документация и подключение к такси
...
?><?php get_header();?>
	...
	<div class="section_docs">
		<div class="container">
			<div class="section_docs_title">
				<h1><?php echo $block_main['zagolovok'];?></h1>
				<div class="section_docs_items">
					<?php if( $block_main['dokumenty'] ):
						$repeaters = $block_main['dokumenty'];
							foreach($repeaters as $repeater) {
								echo '
									<div class="section_docs_item">
										<div class="section_docs_item_img">
											<img src="https://justneed.site/2399/wp-content/themes/bk-leasing/img/doc.svg" alt="">
										</div>
										<div class="section_docs_item_text">
											<a href="'.$repeater["fajl"].'">'.$repeater["nazvanie"].'</a>
										</div>
									</div>';
								};
								endif; ?>
				...
				<div class="section_docs_subtitle">
					<?php echo $block_main['tekstovyj_blok'];?>
				</div>
			</div>
		</div>
	</div>
