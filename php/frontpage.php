...
if( have_rows('glavnaya') ):
	...
	<div class="section_main">
		<div class="container">
			<div class="section_main_title">
				...
				<div class="section_main_subtitle"><?php echo $block_main['podzagolovok'];?></div>
				<a href="/2399/catalog/">Смотреть каталог автомобилей</a>
			</div>
			<div class="section_main_buttons">
				<div class="section_main_buttons_wrap">
				<?php if( $block_main['ssylki_na_kategorii'] ):
						echo '<ul>';
									$repeaters = $block_main['ssylki_na_kategorii'];
									foreach($repeaters as $repeater) {
										echo '
											<li><a href="'.$repeater["ssylka"].'">'.$repeater["tekst_ssylki"].'</a></li>
											';
			...
			<?php if( $block_main['preimushhestva'] ):
				echo '<div class="section_main_buttons_grey">
						<ul>';
				$repeaters = $block_main['preimushhestva'];
					foreach($repeaters as $repeater) {
						echo '
							<li><a href="#">'.$repeater["tekst"].'</a></li>';
						};
						echo '	</ul>
							</div>';
						endif; ?>
	...
	<?php elseif( get_row_layout() == 'преимущества' ):
		    $advantages = get_sub_field('preimushhestva');
		    ?>
	<div class="section_why">
		<div class="container">
			<div class="section_title">
				<h2><?php echo $advantages['zagolovok'];?></h2>
				<div class="section_subtitle"><?php echo $advantages['podzagolovok'];?></div>
			</div>
			<div class="section_why_blocks">
				<div class="section_why_block plus">
					<?php if($advantages['plyusy'] ):
					echo '<ul>';
					echo '<li class="title">'.$advantages['plyusy']['zagolovok'].'</li>';
					$repeaters = $advantages['plyusy']['plyusy'];
						foreach($repeaters as $repeater) {
							echo '
				...
				<div class="section_why_block minus">
					<?php if($advantages['minusy'] ):
						echo '<ul>';
						echo '<li class="title">'.$advantages['minusy']['zagolovok'].'</li>';
						$repeaters = $advantages['minusy']['plyusy'];
							foreach($repeaters as $repeater) {
								echo '
									<li>'.$repeater["tekst"].'</li>';
								};
	...
	<div class="section_catalog">
		<div class="container">
			...
			<?php $avto = get_sub_field('harakteristiki', 27);
								echo $avto['novizna'];?>
	...
	<div class="section_readmore">
		<div class="container">
			<div class="section_title">
				<h2>Читайте <span class="blue">подробнее</span></h2>
				<div class="section_subtitle">различные виды лизинга на все случаи жизни</div>
			</div>
			<div class="section_readmore_wrap">
				<div class="section_readmore_wrap_item">
					<div class="section_readmore_wrap_item_title">Лизинг физическим лицам</div>
					<div class="section_readmore_wrap_item_text">
						<p>Условия оформления финансовой программы. 
							Срок и стоимость программы лизинга. 
							Легковые автомобили в лизинг.</p>
					</div>
					<div class="section_readmore_wrap_item_link"><a href="service-lising-fl.html">Читать далее</a></div>
				</div>
				<div class="section_readmore_wrap_item">
					<div class="section_readmore_wrap_item_title">Лизинг юридическим лицам</div>
					<div class="section_readmore_wrap_item_text">
						<p>Условия оформления финансовой программы. 
							Срок и стоимость программы лизинга. 
							Легковые автомобили, спецтехника в лизинг.</p>
					</div>
					<div class="section_readmore_wrap_item_link"><a href="service-lising-fl.html">Читать далее</a></div>
				</div>
				<div class="section_readmore_wrap_item">
					<div class="section_readmore_wrap_item_title">Такси для физических лиц</div>
					<div class="section_readmore_wrap_item_text">
						<p>Условия оформления финансовой программы. 
							Срок и стоимость программы лизинга такси. 
							Легковые автомобили в лизинг.</p>
					</div>
					<div class="section_readmore_wrap_item_link"><a href="service-lising-fl.html">Читать далее</a></div>
				</div>
				<div class="section_readmore_wrap_item">
					<div class="section_readmore_wrap_item_title">Авто с пробегом</div>
					<div class="section_readmore_wrap_item_text">
						<p>Условия оформления финансовой программы. 
							Срок и стоимость программы лизинга. 
							Легковые автомобили с пробегом в лизинг.</p>
					</div>
					<div class="section_readmore_wrap_item_link"><a href="service-lising-fl.html">Читать далее</a></div>
				</div>
				<div class="section_readmore_wrap_item">
					<div class="section_readmore_wrap_item_title">Аренда с выкупом</div>
					<div class="section_readmore_wrap_item_text">
						<p>Условия оформления финансовой программы. 
							Срок и стоимость программы лизинга с выкупом. 
							Легковые автомобили с выкупом в лизинг.</p>
					</div>
					<div class="section_readmore_wrap_item_link"><a href="service-lising-fl.html">Читать далее</a></div>
				</div>
				<div class="section_readmore_wrap_item">
					<div class="section_readmore_wrap_item_title">Лизинг спецтехники</div>
					<div class="section_readmore_wrap_item_text">
						<p>Условия оформления финансовой программы. 
							Срок и стоимость программы лизинга. 
							Спецтехника в лизинг.</p>
					</div>
					<div class="section_readmore_wrap_item_link"><a href="service-lising-fl.html">Читать далее</a></div>
				</div>
			</div>
